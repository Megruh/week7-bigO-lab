...
// ANSWER: No, because we are stopping it at four so it's as fast as it could go
...
// ANSWER: No, because the space is determined by the size of the array, so we can't fix the amount of data
...
// ANSWER: both functions take in a string, which can change in length, and both functions are dependent on that string length, which can change
